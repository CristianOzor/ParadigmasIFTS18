...
"""def ejercicio5():
	...
	for number in range(10):
		userValue = int(input ("Ingrese un número entero"))
...
resultado = excercise(userInput1,userInput2)
print(resultado)"""

def excercise11(userInput):
	worldList = userInput.split()
	return len(worldList = [-1])
